...
<title>LANDSCAPEHOTEL in 神戸 | フロアガイド</title>
<!-- InstanceEndEditable -->
<link href="../css/common.css" rel="stylesheet" media="screen">
<link href="../css/floorguide.css" rel="stylesheet" type="text/css" media="screen">
...
<article>
  <div class="fgWapper">
  <h2><img src="../images/fgImage.jpg" width="900" height="180" alt="FLOORGUIDE フロアガイド"></h2>
  <h3><img src="../images/fgTitle.gif" width="550" height="38" alt="FloorGuide フロアガイド"></h3>
  <h4><img src="../images/floorMap.gif" width="750" height="420" alt="フロアマップ"></h4>
  <table>
    <tr>
      <td class="rb">10F</td>
      <td>チャペル</td>
    ...
    <tr>
      <td class="rb">3F</td>
      <td><p>フランス料理店「CHALEUREUX シャフール</p>
        <p>日本料理＆定食「春風 はるかぜ」</p></td>
      </tr>
    <tr>
      <td class="rb">2F</td>
      <td><p>CAFE</p>
    ...
    <tr>
      <td class="rb_none">B1F</td>
      <td class="b_none">駐車場</td>
      </tr>
  </table>
